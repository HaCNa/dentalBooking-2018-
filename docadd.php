...
<div class="content">
		<form action="docadd1.php" method="post">
	<h1> Add Doctor </h1>
	<table border="0" cellpadding="5" cellspacing="0">
				<tr>
					<td>Name</td>
					<td><input class="input" type="text" name="doctor_name" autofocus required></td><br>
				</tr>
				<tr>
					<td>Contact</td>
					<td><input class="input" type="int" name="doctor_contact" required></td>
				</tr>
				<tr>
					<td><label for="subject">Description</label></td>
					<td><textarea id="subject" name="doctor_desc" style="height:100px; width:250px;" required></textarea></td>
